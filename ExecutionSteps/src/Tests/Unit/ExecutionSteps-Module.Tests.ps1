# Auto-generated tests from Catesta https://github.com/techthoughts2/Catesta
# Performs basic tests on the module, checking that it exports what it claims and that exported functions are described
...
Describe 'Module Tests' -Tag Unit {
    Context "Module Tests" {
        ...
        It 'root module ExecutionSteps.psm1 should exist' {
            $PathToModule | Should -Exist
            $? | Should -BeTrue
        } #psm1Exists

        It 'manifest should contain ExecutionSteps.psm1' {
            $PathToManifest |
            Should -FileContentMatchExactly "ExecutionSteps.psm1"
        } #validPSM1
